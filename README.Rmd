...
two databases together such as [DrugBank](https://www.drugbank.ca/) and [KEGG](https://www.genome.jp/kegg/).

Hence, `dbparser` package aims to parse different public drugs databases as [DrugBank](https://www.drugbank.ca/) or [KEGG](https://www.genome.jp/kegg/) into
...
### dvobject Structure
`dvobject` is an R list object that contains one or more of the following sub-lists:
