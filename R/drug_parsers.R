...
parse_drug <- function(save_table = TRUE) {
    # db connection
    drugs <- purrr::map_df(children, ~drug_df(.x))
    if (save_table) {
...
parse_drug_groups <- function(save_table = TRUE) {
    drug_groups <- purrr::map_df(children, ~drug_sub_df(.x, "groups"))
    if (save_table) {
...
parse_drug_articles <- function(save_table = TRUE) {
    drug_articles <- purrr::map_df(children, ~drug_sub_df(.x, "general-references",
...
parse_drug_books <- function(save_table = TRUE) {
    drug_books <- purrr::map_df(children, ~drug_sub_df(.x, "general-references", seconadary_node = "textbooks"))
    if (save_table) {
...
parse_drug_links <- function(save_table = TRUE) {
    drug_links <- purrr::map_df(children, ~drug_sub_df(.x, "general-references", seconadary_node = "links"))
    if (save_table) {
...
parse_drug_classfications <- function(save_table = TRUE) {
    drug_classfications <- purrr::map_df(children, ~drug_classfications_df(.x))
    if (save_table) {
...
parse_drug_synonyms <- function(save_table = TRUE) {
    drug_synonyms <- purrr::map_df(children, ~get_synonyms_df(.x))
    if (save_table) {
...
parse_drug_products <- function(save_table = TRUE) {
    drug_products <- purrr::map_df(children, ~drug_sub_df(.x, "products"))
    if (save_table) {
...
parse_drug_mixtures <- function(save_table = TRUE) {
    drug_mixtures <- purrr::map_df(children, ~drug_sub_df(.x, "mixtures"))
    if (save_table) {
...
parse_drug_packagers <- function(save_table = TRUE) {
    drug_packagers <- purrr::map_df(children, ~drug_sub_df(.x, "packagers"))
    if (save_table) {
...
parse_drug_manufacturers <- function(save_table = TRUE) {
    drug_manufacturers <- purrr::map_df(children, ~drug_sub_df(.x, "manufacturers"))
    if (save_table) {
...
parse_drug_prices <- function(save_table = TRUE) {
    drug_prices <- purrr::map_df(children, ~get_prices_df(.x))
    if (save_table) {
...
parse_drug_categories <- function(save_table = TRUE) {
    drug_categories <- purrr::map_df(children, ~drug_sub_df(.x, "categories"))
    if (save_table) {
...
parse_drug_affected_organisms <- function(save_table = TRUE) {
    drug_affected_organisms <- purrr::map_df(children, ~drug_sub_df(.x, "affected-organisms"))
    if (save_table) {
...
parse_drug_dosages <- function(save_table = TRUE) {
    drug_dosages <- purrr::map_df(children, ~drug_sub_df(.x, "dosages"))
    if (save_table) {
...
parse_drug_atc_codes <- function(save_table = TRUE) {
    drug_atc_codes <- purrr::map_df(children, ~get_atc_codes_df(.x))
    if (save_table) {
...
parse_drug_ahfs_codes <- function(save_table = TRUE) {
    drug_ahfs_codes <- purrr::map_df(children, ~drug_sub_df(.x, "ahfs-codes"))
    if (save_table) {
...
parse_drug_pdb_entries <- function(save_table = TRUE) {
    drug_pdb_entries <- purrr::map_df(children, ~drug_sub_df(.x, "pdb-entries"))
    if (save_table) {
...
parse_drug_patents <- function(save_table = TRUE) {
    drug_patents <- purrr::map_df(children, ~drug_sub_df(.x, "patents"))
    if (save_table) {
...
parse_drug_food_interactions <- function(save_table = TRUE) {
    drug_food_interactions <- purrr::map_df(children, ~drug_sub_df(.x, "food-interactions"))
    if (save_table) {
...
parse_drug_interactions <- function(save_table = TRUE) {
    drug_drug_interactions <- purrr::map_df(children, ~drug_sub_df(.x, "drug-interactions"))
    if (save_table) {
...
parse_drug_sequences <- function(save_table = TRUE) {
    drug_sequences <- purrr::map_df(children, ~get_sequences_df(.x))
    if (save_table) {
...
parse_drug_experimental_properties <- function(save_table = TRUE) {
    drug_experimental_properties <- purrr::map_df(children, ~drug_sub_df(.x, "experimental-properties"))
    if (save_table) {
...
parse_drug_external_identifiers <- function(save_table = TRUE) {
    drug_external_identifiers <- purrr::map_df(children, ~drug_sub_df(.x, "external-identifiers"))
    if (save_table) {
...
parse_drug_external_links <- function(save_table = TRUE) {
    drug_external_links <- purrr::map_df(children, ~drug_sub_df(.x, "external-links"))
    if (save_table) {
...
parse_drug_pathway <- function(save_table = TRUE) {
    drug_pathway <- purrr::map_df(children, ~get_pathways_df(.x))
    if (save_table) {
...
parse_drug_pathway_drugs <- function(save_table = TRUE) {
    drug_pathway_drugs <- purrr::map_df(children, ~get_pathways_drugs_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_pathway_enzyme <- function(save_table = TRUE) {
    drug_pathway_enzymes <- purrr::map_df(children, ~get_pathways_enzymes_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_snp_effects <- function(save_table = TRUE) {
    drug_snp_effects <- purrr::map_df(children, ~drug_sub_df(.x, "snp-effects"))
    if (save_table) {
...
parse_drug_snp_adverse_drug_reactions <- function(save_table = TRUE) {
    drug_snp_adverse_drug_reactions <- purrr::map_df(children, ~drug_sub_df(.x, "snp-adverse-drug-reactions"))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_enzymes <- function(save_table = TRUE) {
    drug_enzymes <- purrr::map_df(children, ~get_enzymes_df(.x))
    if (save_table) {
...
parse_drug_enzymes_actions <- function(save_table = TRUE) {
    drug_enzymes_actions <- purrr::map_df(children, ~get_enzymes_actions_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_targets_actions <- function(save_table = TRUE) {
    drug_targets_actions <- purrr::map_df(children, ~get_targets_actions_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_carriers_actions <- function(save_table = TRUE) {
    drug_carriers_actions <- purrr::map_df(children, ~get_carriers_actions_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_transporters_actions <- function(save_table = TRUE) {
    drug_transporters_actions <- purrr::map_df(children, ~get_transporters_actions_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_enzymes_articles <- function(save_table = TRUE) {
    drug_enzymes_articles <- purrr::map_df(children, ~get_enzymes_articles_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_targets_articles <- function(save_table = TRUE) {
    drug_targets_articles <- purrr::map_df(children, ~get_targets_articles_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_carriers_articles <- function(save_table = TRUE) {
    drug_carriers_articles <- purrr::map_df(children, ~get_carriers_articles_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_transporters_articles <- function(save_table = TRUE) {
    drug_transporters_articles <- purrr::map_df(children, ~get_transporters_articles_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_targets_textbooks <- function(save_table = TRUE) {
    drug_targets_textbooks <- purrr::map_df(children, ~get_targets_textbooks_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_carriers_textbooks <- function(save_table = TRUE) {
    drug_carriers_textbooks <- purrr::map_df(children, ~get_carriers_textbooks_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_transporters_textbooks <- function(save_table = TRUE) {
    drug_transporters_textbooks <- purrr::map_df(children, ~get_transporters_textbooks_df(.x))
    if (save_table) {
...
parse_drug_enzymes_textbooks <- function(save_table = TRUE) {
    drug_enzymes_textbooks <- purrr::map_df(children, ~get_enzymes_textbooks_df(.x))
    if (save_table) {
...
parse_drug_enzymes_links <- function(save_table = TRUE) {
    drug_enzymes_links <- purrr::map_df(children, ~get_enzymes_links_df(.x))
    if (save_table) {
...
parse_drug_targets_links <- function(save_table = TRUE) {
    drug_targets_links <- purrr::map_df(children, ~get_targets_links_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_carriers_links <- function(save_table = TRUE) {
    drug_carriers_links <- purrr::map_df(children, ~get_carriers_links_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_transporters_links <- function(save_table = TRUE) {
    drug_transporters_links <- purrr::map_df(children, ~get_transporters_links_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_enzymes_polypeptides <- function(save_table = TRUE) {
    drug_enzymes_polypeptides <- purrr::map_df(children, ~get_enzymes_polypeptide_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_targets_polypeptides <- function(save_table = TRUE) {
    drug_targets_polypeptides <- purrr::map_df(children, ~get_targets_polypeptide_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_carriers_polypeptides <- function(save_table = TRUE) {
    drug_carriers_polypeptides <- purrr::map_df(children, ~get_carriers_polypeptide_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_transporters_polypeptides <- function(save_table = TRUE) {
    drug_transporters_polypeptides <- purrr::map_df(children, ~get_transporters_polypeptide_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_enzymes_polypeptides_external_identifiers <- function(save_table = TRUE) {
    drug_enzymes_polypeptide_external_identifiers <-
      purrr::map_df(children, ~get_enzymes_polypeptide_external_identifiers_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_targets_polypeptides_external_identifiers <- function(save_table = TRUE) {
    drug_targets_polypeptide_external_identifiers <-
      purrr::map_df(children, ~get_targets_polypeptide_external_identifiers_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_carriers_polypeptides_external_identifiers <- function(save_table = TRUE) {
    drug_carriers_polypeptide_external_identifiers <-
      purrr::map_df(children, ~get_carriers_polypeptide_external_identifiers_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_transporters_polypeptides_external_identifiers <- function(save_table = TRUE) {
    drug_transporters_polypeptide_external_identifiers <-
      purrr::map_df(children, ~get_transporters_polypeptide_external_identifiers_df(.x))
    if (save_table) {
      save_drug_sub(con = con,
...
parse_drug_enzymes_polypeptides_synonyms <- function(save_table = TRUE) {
    drug_enzymes_polypeptide_synonyms <- purrr::map_df(children,
...
parse_drug_targets_polypeptides_synonyms <- function(save_table = TRUE) {
    drug_targets_polypeptide_synonyms <- purrr::map_df(children,
...
parse_drug_carriers_polypeptides_synonyms <- function(save_table = TRUE) {
    drug_carriers_polypeptide_synonyms <- purrr::map_df(children,
...
parse_drug_transporters_polypeptides_synonyms <- function(save_table = TRUE) {
    drug_transporter_polypeptide_synonyms <- purrr::map_df(children,
...
parse_drug_enzymes_polypeptides_pfams <- function(save_table = TRUE) {
    drug_enzymes_polypeptide_pfams <- purrr::map_df(children,
...
parse_drug_targets_polypeptides_pfams <- function(save_table = TRUE) {
    drug_targets_polypeptide_pfams <- purrr::map_df(children,
...
parse_drug_carriers_polypeptides_pfams <- function(save_table = TRUE) {
    drug_carriers_polypeptide_pfams <- purrr::map_df(children,
...
parse_drug_transporters_polypeptides_pfams <- function(save_table = TRUE) {
    drug_transporters_polypeptides_pfams <- purrr::map_df(children,
...
parse_drug_enzymes_polypeptides_go_classifiers <- function(save_table = TRUE) {
    drug_enzymes_polypeptides_go_classifiers <- purrr::map_df(children,
...
parse_drug_targets_polypeptides_go_classifiers <- function(save_table = TRUE) {
    drug_targets_polypeptides_go_classifiers <- purrr::map_df(children,
...
parse_drug_carriers_polypeptides_go_classifiers <- function(save_table = TRUE) {
    drug_carriers_polypeptides_go_classifiers <- purrr::map_df(children,
...
parse_drug_transporters_polypeptides_go_classifiers <- function(save_table = TRUE) {
    drug_transporters_polypeptides_go_classifiers <- purrr::map_df(children,
...
parse_drug_reactions <- function(save_table = TRUE) {
    drug_reactions <- purrr::map_df(children, ~get_reactions_df(.x))
    if (save_table) {
...
parse_drug_reactions_enzymes <- function(save_table = TRUE) {
    drug_reactions_enzymes <- purrr::map_df(children, ~get_reactions_enzymes_df(.x))
    if (save_table) {
...
parse_drug_carriers <- function(save_table = TRUE) {
    drug_carriers <- purrr::map_df(children, ~get_carriers_df(.x))
    if (save_table) {
...
parse_drug_transporters <- function(save_table = TRUE) {
    drug_transporters <- purrr::map_df(children, ~get_transporters_df(.x))
    if (save_table) {
...
parse_drug_targets <- function(save_table = TRUE) {
    drug_targets <- purrr::map_df(children, ~get_targets_df(.x))
    if (save_table) {
