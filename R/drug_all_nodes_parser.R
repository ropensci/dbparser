...
#' }
#' @export
parse_drug_all <- function(save_table = FALSE, save_csv = FALSE, csv_path = ".", override_csv = FALSE) {
  Drugs <- parse_drug(save_table, save_csv, csv_path, override_csv)
  print("Parsed Drugs main attributes, 1/75")
  Groups_Drug <- parse_drug_groups(save_table, save_csv, csv_path, override_csv)
  ...
  Links_Drug <- parse_drug_links(save_table, save_csv, csv_path, override_csv)
  ...
  Categories_Drug <- parse_drug_categories(save_table, save_csv, csv_path, override_csv)
  ...
  Patents_Drug <- parse_drug_patents(save_table, save_csv, csv_path, override_csv)
  ...
  Reactions_Drug <- parse_drug_reactions(save_table, save_csv, csv_path, override_csv)
  ...
  Calculated_Properties_Drug <- parse_drug_calculated_properties(save_table, save_csv, csv_path, override_csv)
...
#' }
#' @export
parse_drug_element <- function(elements_options = c("all"), save_table = FALSE, save_csv = FALSE,
