...
# get_xml_db_rows("../drugbank_all_full_database.xml.zip")
...
`dbparser` include MS SQL Server, MySQL and any database supported by `DBI` 
package. Following is an example of saving the parsed data into a MySQL 
database.
