...
test_attributes(desc = "Read darug pathway attributes",
          code = {
...
test_attributes(desc = "Read darug pathway drugs attributes",
          code = {
...
test_attributes(desc = "Read darug pathway enzyme attributes",
          code = {
