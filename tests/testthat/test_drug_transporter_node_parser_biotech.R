...
test_that(
  ...
  code = {
    expect_equal(
      nrow(parse_drug_trans_articles()),
      0
    )
...
test_that(
  ...
  code = {
    expect_equal(
      nrow(parse_drug_trans_textbooks()),
      0
    )
