...
test_attributes(desc = "Read darug prices attributes",
          code = {
...
test_attributes(desc = "Read darug categories attributes",
          code = {
...
test_attributes(desc = "Read darug affected organisms attributes",
          code = {
...
test_attributes(desc = "Read darug dosages attributes",
          code = {
...
test_attributes(desc = "Read darug atc codes attributes",
          code = {
...
test_attributes(desc = "Read darug ahfs codes attributes",
          code = {
...
test_attributes(desc = "Read darug pdb entries attributes",
          code = {
...
test_attributes(desc = "Read darug patents attributes",
          code = {
...
test_attributes(desc = "Read darug interactions attributes",
          code = {
...
test_attributes(desc = "Read darug food interactions attributes",
          code = {
...
test_attributes(desc = "Read darug sequences attributes",
          code = {
...
test_attributes(desc = "Read darug experimental properties attributes",
          code = {
...
test_attributes(desc = "Read darug external identifiers attributes",
          code = {
            expect_match(
...
test_attributes(desc = "Read darug external links attributes",
          code = {
...
test_attributes(desc = "Read darug snp effects attributes",
          code = {
...
test_attributes(desc = "Read darug snp adverse drug reactions attributes",
          code = {
