...
test_that(
  ...
  code = {
    expect_equal(
      nrow(parse_drug_enzymes_actions()),
      1
    )
...
test_that(
  ...
  code = {
    expect_equal(
      nrow(parse_drug_enzymes_articles()),
      1
    )
...
test_that(
  ...
  code = {
    expect_equal(
      nrow(parse_drug_enzymes_textbooks()),
      0
    )
