...
test_attributes(desc = "Read darug enzymes attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes actions attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes articles attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes textbooks attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes links attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes polypeptides attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes polypeptides external identifiers attributes",
          code = {
            expect_equal(nrow(
...
test_attributes(desc = "Read darug enzymes polypeptides synonyms attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes polypeptides pfams attributes",
          code = {
...
test_attributes(desc = "Read darug enzymes polypeptides go classifiers attributes",
          code = {
