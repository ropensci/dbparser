...
# parse DrugBank DB - small molecule
    ...
    Output
      ...
      # A tibble: 1 × 9
        description   direct_parent kingdom superclass class subclass alternative_par…
        <chr>         <chr>         <chr>   <chr>      <chr> <chr>    <chr>           
      1 This compoun… Polypeptides  Organi… Organic P… Poly… ""       1-hydroxy-2-uns…
      # … with 2 more variables: substituents <chr>, drugbank_id <chr>
      ...
      # A tibble: 1 × 12
        drugbank_id indication   pharmacodynamics mechanism_of_ac… toxicity metabolism
        <chr>       <chr>        <chr>            <chr>            <chr>    <chr>     
      1 DB00006     For treatme… "Bivalirudin di… Inhibits the ac… Based o… 80% prote…
      # … with 6 more variables: absorption <chr>, half_life <chr>,
      #   protein_binding <chr>, route_of_elimination <chr>,
      #   volume_of_distribution <chr>, clearance <chr>
      ...
      2 Injection                                    Intracaverno… 250 mg/1 DB00006   
      ...
      # A tibble: 398 × 4
         `drugbank-id` name                 description                     parent_key
         <chr>         <chr>                <chr>                           <chr>     
       1 DB01323       St. John's Wort      The metabolism of Bivalirudin … DB00006   
       2 DB00346       Alfuzosin            The serum concentration of Alf… DB00006   
       3 DB13783       Acemetacin           The risk or severity of bleedi… DB00006   
       4 DB06605       Apixaban             Apixaban may increase the anti… DB00006   
       5 DB06695       Dabigatran etexilate Dabigatran etexilate may incre… DB00006   
       6 DB09075       Edoxaban             Edoxaban may increase the anti… DB00006   
       7 DB06228       Rivaroxaban          Bivalirudin may increase the a… DB00006   
       8 DB00227       Lovastatin           The serum concentration of Lov… DB00006   
       9 DB00013       Urokinase            Urokinase may increase the ant… DB00006   
      10 DB09030       Vorapaxar            The risk or severity of advers… DB00006   
      # … with 388 more rows
      ...
      # A tibble: 15 × 19
         name             labeller `ndc-id` `ndc-product-c…` `dpd-id` `ema-product-c…`
         <chr>            <chr>    <chr>    <chr>            <chr>    <chr>           
       1 Angiomax         Sandoz … ""       ""               "022465… ""              
       2 Angiomax         The Med… ""       "65293-001"      ""       ""              
       3 Angiomax         Cardina… ""       "55154-2275"     ""       ""              
       4 Bivalirudin      Freseni… ""       "63323-562"      ""       ""              
       5 Bivalirudin      Sandoz … ""       ""               "024504… ""              
       6 Bivalirudin      Sandoz   ""       "0781-3158"      ""       ""              
       7 Bivalirudin      Dr Redd… ""       "55111-652"      ""       ""              
       8 Bivalirudin      Sandoz   ""       "0781-9158"      ""       ""              
       9 Bivalirudin      Mylan I… ""       "67457-256"      ""       ""              
      10 Bivalirudin      Sagent … ""       "25021-405"      ""       ""              
      11 Bivalirudin      Apotex … ""       "60505-6101"     ""       ""              
      12 Bivalirudin      Hospira… ""       "0409-8300"      ""       ""              
      13 Bivalirudin for… Freseni… ""       ""               "024352… ""              
      14 Bivalirudin in … Baxter … ""       "0338-9572"      ""       ""              
      15 Bivalirudin in … Baxter … ""       "0338-9576"      ""       ""              
      # … with 13 more variables: `ema-ma-number` <chr>,
      #   `started-marketing-on` <chr>, `ended-marketing-on` <chr>,
      #   `dosage-form` <chr>, strength <chr>, route <chr>,
      #   `fda-application-number` <chr>, generic <chr>, `over-the-counter` <chr>,
      ...
      2 17381384    Dager WE, Dougherty JA, Nguyen PH, Militello MA, Smyth… DB00006   
      3 16553503    Dang CH, Durkalski VL, Nappi JM: Evaluation of treatme… DB00006   
      4 11156732    Robson R: The use of bivalirudin in patients with rena… DB00006   
      5 21108549    Van De Car DA, Rao SV, Ohman EM: Bivalirudin: a review… DB00006   
      6 16614733    Shammas NW: Bivalirudin: pharmacology and clinical app… DB00006   
      7 12851152    Gleason TG, Chengelis CP, Jackson CB, Lindstrom P: A 2… DB00006   
      ...
      # A tibble: 1 × 3
        `pubmed-id` citation                                                parent_key
        <chr>       <chr>                                                   <chr>     
      1 18701766    Rudolph V, Rudolph TK, Schopfer FJ, Bonacci G, Lau D, … BE0001075 
      ...
      # A tibble: 6 × 3
        `pubmed-id` citation                                                parent_key
        <chr>       <chr>                                                   <chr>     
      1 11060732    Scatena R: Bivalirudin: a new generation antithromboti… BE0000048 
      2 11504570    Bates ER: Bivalirudin for percutaneous coronary interv… BE0000048 
      3 11833835    Gladwell TD: Bivalirudin: a direct thrombin inhibitor.… BE0000048 
      4 11923794    Kleiman NS, Klem J, Fernandes LS, Rubin H, Challa S, S… BE0000048 
      5 11929334    Carswell CI, Plosker GL: Bivalirudin: a review of its … BE0000048 
      6 11752352    Chen X, Ji ZL, Chen YZ: TTD: Therapeutic Target Databa… BE0000048 
      ...
      $cett$enzymes$general_information
      # A tibble: 1 × 8
        id        name      organism known_action position parent_key `inhibition-st…`
        <chr>     <chr>     <chr>    <chr>        <chr>    <chr>      <chr>           
      1 BE0001075 Myeloper… Human    unknown      1        DB00006    unknown         
      # … with 1 more variable: `induction-strength` <chr>
      ...
      # A tibble: 1 × 20
        id     source     name       general_function specific_functi… gene_name locus
        <chr>  <chr>      <chr>      <chr>            <chr>            <chr>     <chr>
      1 P05164 Swiss-Prot Myelopero… Peroxidase acti… Part of the hos… MPO       17q2…
      # … with 13 more variables: cellular_location <chr>,
      #   transmembrane_regions <chr>, signal_regions <chr>, theoretical_pi <chr>,
      #   molecular_weight <chr>, chromosome_location <chr>, organism <chr>,
      #   organism_ncbi_taxonomy_id <chr>, amino_acid_sequence <chr>,
